...
jsPsych.plugins['survey-text'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      html += '<div id="jspsych-survey-text-'+question_index+'" class="jspsych-survey-text-question" style="margin: 2em 30em;">';
    ...
    setTimeout(function(){ document.getElementById('jspsych-survey-text-next').style.visibility = 'visible';}, trial.view_duration);
